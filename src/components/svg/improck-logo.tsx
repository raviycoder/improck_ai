...
const ImprockLogo: React.FC<ImprockLogoProps> = ({
    width = 39,
    height = 28,
    fill,
    className,
    ...
    // If fill is explicitly provided, use it; otherwise use theme-based color
    const logoFill = fill || (mounted && theme === 'dark' ? '#60A5FA' : '#3B82F6');
